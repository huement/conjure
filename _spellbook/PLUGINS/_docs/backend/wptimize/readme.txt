...
= 1.1.1 =
* Fixed a bug that cause a conflict with tabs on WooCommerce settings.
...
== Screenshots ==
1. WPtimize settings - Cleanup tab
2. WPtimize settings - Optimization tab
3. WPtimize settings - Memory Usage tab
4. WPtimize settings - Customizations tab