...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="//magic.app/VVV/style.css?t=<?php echo intval( filemtime( __DIR__.'/style.css' ) ); ?>">
	</head>
	<body>
		<h2 id="vvv_logo">
			<img src="//magic.app/VVV/vvv-tight.png"/> Varying Vagrant Vagrants
		</h2>
		<?php
