    ...
    <div class="card border-warning mb-3">
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-wrap" id="myTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="home-tab" href="#home" data-toggle="tab" role="tab">About</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="offer-tab" href="#offer" data-toggle="tab" role="tab">Offer</a>
            </li>
          </ul>
        </div>
