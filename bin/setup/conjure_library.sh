...
# ------------------ ---------  ------   ----    ---     --      -
function info() { echo " ${BOLD}${WHT}${B_BLU}[INFO]${NORMAL}${BLU} ➜${NORMAL}  $@" | tee -a "$LOG_FILE" >&2; }
function warning() { echo " ${BOLD}${WHT}${B_GRN}[ OK ]${NORMAL}${GRN} ✔${NORMAL}  $@" | tee -a "$LOG_FILE" >&2; }
function warning() { echo " ${BOLD}${WHT}${B_YLW}[WARN]${NORMAL}${YLW} ➜${NORMAL}  $@" | tee -a "$LOG_FILE" >&2; }
function error() { echo " ${BOLD}${WHT}${B_RED}[FAIL]${NORMAL}${RED} ✖${NORMAL}  $@" | tee -a "$LOG_FILE" >&2; }
function fatal() {
